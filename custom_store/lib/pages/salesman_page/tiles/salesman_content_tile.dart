...
class SalesmanContentTile extends StatefulWidget {
  ...
  SalesmanContentTile({this.salesmanSnapshot,
    ...
    return Observer(
      builder: (context) =>
          Slidable(
            ...
            actions: <Widget>[
              Container(
                decoration: getDecoration(color: Colors.blue,
                    topLeft: radius,
                    bottomLeft: radius,
                    bottomRight: 0,
                    topRight: 0),
              ...
              Container(
                decoration: getDecoration(color: Colors.red,
                    topRight: radius,
                    bottomRight: radius,
                    bottomLeft: 0,
                    topLeft: 0),
                ...
                child: IconSlideAction(
                  ...
                  onTap: () {
                    ...
                    Salesman currentSalesman = Salesman().fromMap(widget.salesmanSnapshot);
                    ...
                    widget.salesmanController.scaffoldKey.currentState
                        ...
                        snackBarAction: SnackBarAction(label: "DESFAZER",
            ...
            child: Container(
              ...
              child: ListTile(
                  ...
                  subtitle: Text(
                      "Comissão: ${widget.salesman.comission.toStringAsFixed(
                          2)}"),
