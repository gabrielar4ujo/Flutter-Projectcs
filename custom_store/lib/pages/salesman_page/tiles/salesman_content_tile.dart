...
class _SalesmanContentTileState extends State<SalesmanContentTile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(
      builder: (context) => Slidable(
        ...
        actions: <Widget>[
          Container(
            decoration: getDecoration(color: Colors.blue, topLeft: radius, bottomLeft: radius,bottomRight: 0,topRight: 0),
          ...
          Container(
            decoration: getDecoration(color: Colors.red, topRight: radius, bottomRight: radius,bottomLeft: 0,topLeft: 0),
            ...
            child: IconSlideAction(
              ...
              icon: Icons.delete,
              onTap: () {
                widget.salesmanController.scaffoldKey.currentState.showSnackBar(widget.salesmanController.getSnackBar(message: "DELETADO com sucesso!",
                    snackBarAction: SnackBarAction(label: "DESFAZER",textColor: Colors.red,onPressed: (){
                      print("NAME: ${widget.salesman.name}");
                      widget.crudSalesmanController.insert(categoryName: widget.salesman.name, comission: widget.salesman.comission.toStringAsFixed(2));
                    },)));
  ...
  BoxDecoration getDecoration({Color color, double topLeft, double topRight, double bottomLeft, double bottomRight}) {
    return BoxDecoration(
        borderRadius: BorderRadius.only(
            ...
            bottomRight: Radius.circular(bottomRight ?? this.radius)) /*BorderRadius.circular(8)*/,
