...
class CustomBottomSheetWidget extends StatefulWidget {
  ...
  CustomBottomSheetWidget({Key key, this.lastName, this.documentID, this.userUID, this.allProductsList}) : super(key: key);

  @override
  _CustomBottomSheetWidgetState createState() => _CustomBottomSheetWidgetState(documentID: documentID,userUID: userUID,allProductsList: allProductsList,lastName: lastName);
}
...
class _CustomBottomSheetWidgetState extends State<CustomBottomSheetWidget> {
  ...
  _CustomBottomSheetWidgetState({this.lastName, this.documentID, this.userUID, this.allProductsList});
            ...
            children: <Widget>[
              FlatButton(onPressed: ()async {
                ...
                var bottomSheetController = showModalBottomSheet(
                  ...
                  return BottomTextFieldWidget(lastName: lastName,documentID: documentID,);
                }, context: context);
              ...
              FlatButton(onPressed: (){
                ...
                allProductsList.forEach((key, value) async {
                  await value['pictures'].forEach((url)=>_productController.deletePictures(url));
                });

                _crudController.delete(documentID: documentID).then((value) {
